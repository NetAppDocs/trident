...
Trident uses various ports for communication inside Kubernetes clusters and with storage backends. Below is a summary of key ports, their purposes, and security considerations.
...
** For NFSv4 (default in Trident), prune UDP/older NFSv3 ports (e.g., 4045-4049) if not needed. 
