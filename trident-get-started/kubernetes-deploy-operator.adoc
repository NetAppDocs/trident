...
+
----
helm install netapp-trident/trident-operator --version 22.10.0 --create-namespace --namespace
----
+
...
----
helm install <name> netapp-trident/trident-operator --version 22.10.0 --set tridentDebug=true
----
