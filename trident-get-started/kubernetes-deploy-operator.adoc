...
. Create the `kustomization.yaml` using the following command where _<bundle>_ is `bundle_pre_1_25.yaml` or `bundle_post_1_25.yaml` based on your Kubernetes version. 
+
----
cp kustomization_<bundle>.yaml
----
. Generate the bundle using using the following command where _<bundle>_ is `bundle_pre_1_25.yaml` or `bundle_post_1_25.yaml` based on your Kubernetes version. 
+
----
