...
|===
|Status |Description
|Installing |The operator is installing Astra Trident using this
...
You can confirm if the Trident installation completed by taking a look at the pods that have been created:
...
TIP: For troubleshooting issues during deployment, see link:troubleshooting.html[here^].
