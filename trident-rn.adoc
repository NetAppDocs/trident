...
With the Astra Trident 23.10 release, a new software component called Astra Control Provisioner will be available to licensed Astra Control users. This provisioner provides access to a superset of advanced management and storage provisioning features beyond those that Astra Trident supports. For the 23.10 release, these features include:
