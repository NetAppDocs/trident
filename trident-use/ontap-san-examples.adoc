...
|`denyNewVolumePools` |Restricts `ontap-san-economy` backends from creating new Flexvols to contain their LUNs. Only preexisting Flexvols are used for provisioning new PVs.
