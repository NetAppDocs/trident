...
NOTE: Refer to link:https://kb.netapp.com/on-prem/ASAr2/ASAr2_KBs/su_create_by_SVM_admin_using_CLI_fails_with_error_No_candidate_aggregates_are_available_for_storage_services[this] Knowledge Base article on how to assign aggregates to SVM in ASA r2 systems.
