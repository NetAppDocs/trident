...
.Result
The user you have granted AppVault permissions to should be able to use the AppVault for application data management operations, and should not be able to access any resources outside of the assigned namespaces.