...
.. Follow the *Add-on configuration schema* and set the *Configuration Values* section based on the authentication method you are using. 
+
For IRSA, use this format:
[source,JSON]
----
{
...
---- 
For Pod Identity, use this format:
+
[source,JSON]
----
{
