...
--
----
helm install <name> netapp-trident/trident-operator --version 100.2410.0 --set imageRegistry=<your-registry> --create-namespace --namespace <trident-namespace>
----
--
...
----
helm install <name> netapp-trident/trident-operator --version 100.2410.0 --set imageRegistry=<your-registry>/sig-storage --set operatorImage=<your-registry>/netapp/trident-operator:24.10.0 --set tridentAutosupportImage=<your-registry>/netapp/trident-autosupport:24.10 --set tridentImage=<your-registry>/netapp/trident:24.10.0 --create-namespace --namespace <trident-namespace>
----
--
====
// end tabbed area
...
For example, to change the default value of `debug`, run the following `--set` command where `100.2410.0` is the version of Trident you are installing:
...
|Allows Trident AutoSupport container to phone home via an HTTP proxy.
|""
...
|`windows`
|Allows Trident to be installed on Windows worker node.
|`false`
