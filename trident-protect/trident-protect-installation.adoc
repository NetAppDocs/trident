...
--
You can install Trident protect from a private image registry if your cluster is unable to access the Internet. In these examples, replace values in brackets with information from your environment:

. Pull the following images to your local machine, and then push them to your private registry:
+
[source,console]
----
