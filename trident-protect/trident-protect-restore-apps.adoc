...
* ##You can customize Trident protect restore operations using annotations and configuration options. To learn more, refer to link:../trident-protect/trident-protect-restore-settings.html[Customize Trident protect restore annotations and options].##
====
