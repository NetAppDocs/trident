...
|`denyNewVolumePools` |Restricts `ontap-san-economy` backends from creating new Flexvols to contain their Qtrees and LUNs respectively. Only preexisting Flexvols are used for provisioning new PVs.
