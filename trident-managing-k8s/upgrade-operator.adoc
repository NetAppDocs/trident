...
* For clusters running Kubernetes 1.24 or earlier, use link:https://github.com/NetApp/trident/tree/stable/v24.02/deploy/bundle_pre_1_25.yaml[bundle_pre_1_25.yaml^].

* For clusters running Kubernetes 1.25 or later, use link:https://github.com/NetApp/trident/tree/stable/v24.02/deploy/bundle_post_1_25.yaml[bundle_post_1_25.yaml^].
...
.. Use the `helm upgrade` command where `trident-operator-24.02.0.tgz` reflects the version that you want to upgrade to.
+
----
