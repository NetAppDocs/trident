...
* You must have a CSI-based Astra Trident installation. All releases from 19.04 on are CSI-based. You can examine the pods in your Trident namespace to verify. 
** Pod naming in versions earlier than 23.01 follows a `trident-csi-*` convention. 
** Pod naming in 23.01 and later follows a `trident-node-<operating system>-*` convention. 
...
Follow these steps to upgrade from Astra Trident 21.01 and later. 
