...
You can set encryption on the volume provisioned by Trident by using the encryption parameter in the backend definition file. For more information, refer to: link:./trident-reco/security-reco.html[How Astra Trident works with NVE and NAE]
