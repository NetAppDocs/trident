...
= Configure an Google Cloud NetApp Volumes backend
:hardbreaks:
:icons: font
:imagesdir: ../media/

[.lead]
You can configure Google Cloud NetApp Volumes as the backend for Astra Trident. You can attach NFS volumes using a Google Cloud NetApp Volumes backend.
