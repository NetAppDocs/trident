...
--
. Create the AppMirrorRelationship CR file:
+
[source,console]
----
tridentctl protect create appmirrorelationship
----
--
====
// end tabbed block
...
[source,console]
----
tridentctl protect create shutdownsnapshot <myshutdownsnapshot> --appvault <my-vault> --app <app_to_snapshot>
----
--
====
// end tabbed block
