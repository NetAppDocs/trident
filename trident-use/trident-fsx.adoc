...
** Trident supports SMB volumes mounted to pods running on Windows nodes only. Refer to link:worker-node-prep.html#prepare-to-provision-smb-volumes[Prepare to provision SMB volumes] for details.
