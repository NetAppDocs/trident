...
When you create a StorageClass, Trident automatically creates the backend configuration. Refer to the <<create-a-kubernetes-storageclass-without-automatic-backend-configuration>> section for how to create the Trident backend and storage class separately.
