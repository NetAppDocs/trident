...
[source,console]
----
kubectl create secret generic gcp-creds --from-file=credentials=<mycreds-file.json> -n trident-protect-system
----
...
[source,console]
----
kubectl create secret generic -n trident-protect-system s3 --from-literal=accessKeyID=<accesskey id> --from-literal=secretAccessKey=<generic-s3-trident-protect-src-bucket-secret>
----
...
[source,console]
----
kubectl create secret generic <secret-name> --from-literal=accountKey=<accountKey> -n trident-protect-system
----
