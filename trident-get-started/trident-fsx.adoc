...
* link:kubernetes-deploy.html[Deploy Trident^]
...
* link:../trident-reco/integrate-trident.html#ontap[Integrate Trident^]
...
. Deploy Trident using one of the link:kubernetes-deploy.html[deployment methods^].
