...
Beginning with the 25.02 release, Trident detects ASA and invokes the latest ASA code automatically. Use the storageDriverName `ontap-san` and sanType `iscsi` for ASA.
