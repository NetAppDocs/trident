...
** Full Red Hat OpenShift virtualization support
** Support for manually running execution hooks using the Trident protect CLI
** Support for annotation of applications to control filesystem freeze behavior in VM environments
+
