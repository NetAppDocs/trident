...
For more information on other configuration options, see the <<first-link,Backend-advanced-configuration-and-examples>> section below.
...
However, to do so you must complete these steps: link:worker-node-prep.html#prepare-to-provision-smb-volumes[Prepare to provision SMB volumes].

== [[first-link]]Backend advanced configuration and examples
