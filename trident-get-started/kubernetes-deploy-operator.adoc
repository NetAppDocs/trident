...
* You have full privileges to a supported Kubernetes cluster running Kubernetes 1.18 - 1.23 and above.
...
To see if your Kubernetes version is later than 1.18, run the following command:
----
kubectl version
----
