...
* Amazon FSx for NetApp ONTAP volumes come preconfigured with a SnapMirror. Deleting PVCs will not succeed, as Trident cannot modify or break them. You will need to delete  PVs manually and clean them up on FSx for ONTAP.
===============================
