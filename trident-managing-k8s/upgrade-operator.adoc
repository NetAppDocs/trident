...
= Upgrade an Trident installation using Trident operator or Helm
:hardbreaks:
:icons: font
:imagesdir: ../media/
...
`bundle_pre_1_25.yaml` or `bundle_post_1_25.yaml` based on your Kubernetes version. For example, if you are installing Trident 24.06, run the following command:
+
----
...
You can upgrade an Trident Helm installation.  
