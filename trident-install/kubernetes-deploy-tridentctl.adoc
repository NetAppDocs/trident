...
----
wget https://github.com/NetApp/trident/releases/download/v24.04.0/trident-installer-24.04.0.tar.gz
tar -xf trident-installer-24.04.0.tar.gz
...
--
----
./tridentctl install -n trident --image-registry <your-registry> --autosupport-image <your-registry>/trident-autosupport:24.04 --trident-image <your-registry>/trident:24.04.0
----
--
...
----
./tridentctl install -n trident --image-registry <your-registry>/sig-storage --autosupport-image <your-registry>/netapp/trident-autosupport:24.04 --trident-image <your-registry>/netapp/trident:24.04.0
----
--
...
INFO Trident REST interface is up.                 version=24.04.0
