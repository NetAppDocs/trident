...
* Trident supports automatic backend configuration for Amazon FSx for NetApp ONTAP. When you create a StorageClass that includes the required parameters, NetApp Trident automatically creates the corresponding backend and VolumeSnapshotClass (if needed).
