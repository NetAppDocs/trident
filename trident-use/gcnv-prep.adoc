...
If you are using Google Cloud NetApp Files for the first time or in a new location, some initial configuration is required to set up Google Cloud NetApp files and create an NFS volume. Refer to link:https://cloud.google.com/netapp/volumes/docs/discover/product-overview[NetApp Volumes product overview].
