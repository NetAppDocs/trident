...
=== Supported snapshot annotations

You can use the following annotations on Snapshot CRs to configure timeout settings:
...
|string
|The maximum time (in minutes) allowed for snapshot completion operations.
|"60"
|protect.trident.netapp.io/volume-snapshots-ready-to-use-timeout
|string
|The maximum time (in minutes) allowed for volume snapshots to become ready to use.
|"30"
|protect.trident.netapp.io/volume-snapshots-created-timeout
|string
|The maximum time (in minutes) allowed for volume snapshot creation.
|"5"
|===
