...
When locating a volume, Trident may try more than one compatible form of the volume name (for example, *hyphen* and *underscore* variants), which improves import and discovery reliability.
