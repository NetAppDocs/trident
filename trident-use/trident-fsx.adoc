...
** Trident supports SMB volumes mounted to pods running on Windows nodes only. Refer to link:worker-node-prep.html#selecting-the-right-tools[Prepare to provision SMB volumes] for details.
