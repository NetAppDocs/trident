...
|Resize
|Replication
| `ontap-nas` | Yes | Yes | Yes | Yes | Yesfootnote:1[] | Yes | Yesfootnote:1[]
| `ontap-nas-economy` | Yesfootnote:3[]| Yesfootnote:3[] | Yes|
Yes | Yesfootnote:3[]| Yes | Yesfootnote:3[]
|`ontap-nas-flexgroup` | Yesfootnote:1[]| No | Yes| Yes |
...
The minimum CVS and CVS-Performance volume size is 100 GiB. 
