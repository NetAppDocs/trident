---
sidebar: sidebar
permalink: trident-backend/gcp.html
keywords: trident backend, cloud volumes service for Google Cloud
...
= Configure CVS for Google Cloud
:hardbreaks:
:icons: font
:imagesdir: ../media/

Learn about how to configure NetApp Cloud Volumes Service (CVS) for Google Cloud as the backend for your Trident installation using the sample configurations provided.
