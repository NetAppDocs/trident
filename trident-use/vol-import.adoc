...
NOTE: The volume path for the Azure NetApp Files volume is present in the mount path after the :/. For example, if the mount path is `10.0.0.2:/importvol1`, the volume path is `importvol1`.
