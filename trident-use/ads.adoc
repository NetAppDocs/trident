...
* A supported ADS storage system. See link:https://docs.netapp.com/us-en/astra-data-store_ads-PI4-review/index.html[Astra Data Store preview documentation^] for details.
