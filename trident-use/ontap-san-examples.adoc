...
|`igroupName` |Astra Trident creates and manages per-node `igroups` as `<nodeName>-<tridentUUID>`. Per-backend `igroups` have been deprecated.
...
----
{
 ...
 "igroupName": "<nodeName>-<tridentUUID>",
