...
* You cannot revoke access to the source PVC by removing the `shareToNamespace` or `shareFromNamepace` annotations or deleting the `TridentVolumeReference` CR. To revoke access, you must delete the subordinate PVC.
