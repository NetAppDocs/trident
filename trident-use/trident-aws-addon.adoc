...
+
Enable the `ontapConfigurator` and specifies `authType`, `fsxnID`, `protocols` to create Trident backend and storage classes automatically soon after Trident installation:
+
image::../media/aws-eks-07.png[]
+
. Select *Create*.
