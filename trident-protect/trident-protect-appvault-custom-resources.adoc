...
NOTE: Depending on which data mover you are using, you only need to include the corresponding password for that data mover. For example, if you are using Restic, you only need to include the Restic password when you create the secret.
