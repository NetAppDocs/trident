...
. Use `helm install` and specify a name for your deployment and image registry location or locations as in the following examples. In the examples, `XX.XX.X` is the version of Astra Trident you are installing. 
+
[role="tabbed-block"]
====
...
--
----
helm install <name> netapp-trident/trident-operator --version <XX.XX.X> --set imageRegistry=<your-registry> --create-namespace --namespace <trident-namespace>
----
--
...
----
helm install <name> netapp-trident/trident-operator --version <XX.XX.X> --set imageRegistry=<your-registry>/sig-storage --set operatorImage=<your-registry>/netapp/trident-operator:23.01.0 --set tridentAutosupportImage=<your-registry>/netapp/trident-autosupport:23.01 --set tridentImage=<your-registry>/netapp/trident:23.01.0 --create-namespace --namespace <trident-namespace>
----
--
====
// end tabbed area
