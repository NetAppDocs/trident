...
|`denyNewVolumePools` |Restricts `ontap-nas-economy` backends from creating new Flexvols to contain their Qtrees. Only preexisting Flexvols are used for provisioning new PVs.
