...
+
For Kubernetes 1.20 and above, use v5. For Kubernetes versions 1.17-1.19 use v1beta1.
+
[role="tabbed-block"]
====
.v5 CRDs
...
+
For Kubernetes 1.20 and above use v4.1.1. For Kubernetes versions 1.17-1.19 use v3.0.3
+
