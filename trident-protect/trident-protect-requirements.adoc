...
If you plan to use https://kubevirt.io/[KubeVirt^] virtual machines with SnapMirror replication, you need to set up virtualization so that you can freeze and unfreeze your SVMs. After you set up virtualization, SVMs you deploy will include the necessary tools to freeze and unfreeze. To learn more about setting up virtualization, refer to https://docs.openshift.com/container-platform/4.17/virt/install/installing-virt.html[Installing OpenShift Virtualization^].
