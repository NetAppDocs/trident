...
For more information on backend configuration options for ONTAP-SAN and ONTAP-SAN-ECONOMY, refer to link:https://docs.netapp.com/us-en/trident/trident-use/ontap-san-examples.html[ONTAP SAN configuration options]
