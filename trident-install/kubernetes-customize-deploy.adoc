...
|
|`TridentOrchestrator`|The QPS used by the controller to communicate with the Kubernetes API server. The Burst value is automatically set as a function of the QPS value. A value of `0` indicates no throttling.| `100`; optional
