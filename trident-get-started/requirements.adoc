...
* Kubernetes 1.26 <<check for 25.06>> - 1.33
* OpenShift 4.10 - 4.18 <<check for 25.06>>
* Rancher Kubernetes Engine 2 (RKE2) v1.26.7+rke2r1, v1.28.5+rke2r1 <<check for 25.06>>

The Trident operator is supported with these releases:

* Anthos On-Prem (VMware) and Anthos on bare metal 1.16 <<check for 25.06>>
* Kubernetes 1.26 - 1.33 <<check for 25.06>>
* OpenShift 4.10 - 4.18 <<check for 25.06>>
* Rancher Kubernetes Engine 2 (RKE2) v1.26.7+rke2r1, v1.28.5+rke2r1 <<check for 25.06>>
...
| v1.26.0, v1.27.0, v1.28.0, v1.29.0, v1.30.0, v1.31.0, v1.32.0, v1.33.0
a|
