...
*Omit for Metrocluster*. See the <<mcc-best>>.|Derived by the SVM
...
NOTE: If you are using Amazon FSx on NetApp ONTAP with Trident, NetApp recommends you specify DNS names for LIFs instead of IP addresses.
