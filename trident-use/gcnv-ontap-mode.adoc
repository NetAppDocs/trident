...
Use the same service account pattern as native GCNV: non-sensitive fields in `gcnv.apiKey`, `private_key` and `private_key_id` in the secret. See link:../trident-use/gcnv-examples.html[Google Cloud NetApp Volumes configuration examples^].
