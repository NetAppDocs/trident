...
[source,console]
----
helm upgrade -n trident-protect trident-protect netapp/trident-protect --set autoSupport.proxy=http://my.proxy.url
----
--
...
[source,console]
----
helm upgrade -n trident-protect trident-protect netapp/trident-protect --set autoSupport.proxy=http://my.proxy.url --set autoSupport.insecure=true
----
--
====