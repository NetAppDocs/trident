...
** Added an option to serve Prometheus metrics with HTTPS. See link:../trident-use/monitor-trident.html[Monitor Trident^]
** Added an option to keep original imported volume name but manage lifecycle with Trident. See link:../trident-use/vol-import.html[Import volumes^]
