...
+
image::../media/aws-eks-02.png[AWS Marketplace add-ons storage category]
+
...
+
image::../media/aws-eks-03.png[Trident add-on version selection]
+
. Configure the required add-on settings.
+
image::../media/aws-eks-04.png[Trident add-on configuration settings]
+
...
+
image::../media/aws-eks-05.png[Trident add-on active status]
+
...
----
. Continue the setup and configure the storage backend. For information, see link:trident-fsx-storage-backend.html[Configure the Storage Backend^].
