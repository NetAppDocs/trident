...
Typically, you will use `tridentctl` on a Kubernetes cluster running Astra Trident. However, you can use one of the following options to use `tridentctl` commands locally on a Kubernetes cluster:
