...
+
----
helm install <release-name> netapp-trident/trident-operator --version 22.04.0 --namespace <trident-namespace>
----
+
...
----
$ helm install <name> netapp-trident/trident-operator --version 22.04.0 --set tridentDebug=true
----
