...
##You can customize AutoSupport settings, namespace filtering, and OpenShift webhook certificate management to meet your specific requirements. The following table describes the available configuration parameters:##
...
|##useOpenshiftServiceCA##
|boolean
|Enables integration with OpenShift's native Service CA Operator for automatic TLS certificate creation and injection for the Trident Protect admission webhook. When set to `true`, the Service CA Operator manages webhook TLS certificates automatically. Use only on OpenShift clusters. (default: `false`)
|===
...
helm upgrade trident-protect -n trident-protect netapp-trident-protect/trident-protect \
  ...
  ##--set useOpenshiftServiceCA=true \##
  --reuse-values
----
--
====
