...
+
NOTE: _While Trident is supported on Rancher Kubernetes Engine 2 (RKE2) versions 1.27.x - 135.x, Trident has currently been qualified on RKE2 v1.28.5+rke2r1 only._
...
| v1.27.0, v1.28.0, v1.29.0, v1.30.0, v1.31.0, v1.32.0, v1.33.0, v135.0
a|
