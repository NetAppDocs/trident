...
Optional when managed identities or cloud identity is enabled on an AKS cluster. |
...
spec:
  ...
  subnet: eastus-anf-subnet
  location: westus2
  subscriptionID: d7a8de29-b829-45c0-b898-2cbafd35e3a3
----
====
