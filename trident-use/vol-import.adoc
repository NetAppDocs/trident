...
== Examples
Review the following volume import examples for the supported drivers.
...
TIP: We suggest importing volumes without active connections. To import an actively-used volume, clone the volume and then perform the import.
