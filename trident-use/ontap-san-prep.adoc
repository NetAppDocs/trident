...
Beginning with the 25.02 release, Trident automatically detects ASA r2 personality of the ONTAP 9.16.1 system and enables the provision and usage of storage on ASA r2.
