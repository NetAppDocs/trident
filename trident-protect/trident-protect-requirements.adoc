...
* Ensure that at least one VolumeSnapshotClass exists. For more information, refer to link:https://docs.netapp.com/us-en/trident_main/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects[VolumeSnapshotClass].
====
