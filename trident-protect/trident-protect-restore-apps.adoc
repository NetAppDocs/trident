...
* ##Restoring a backup to a different namespace or to the original namespace is supported for qtree volumes. However, restoring a snapshot to a different namespace or to the original namespace is not supported for qtree volumes. To restore data for qtree volumes, use backup restore operations.##
====
