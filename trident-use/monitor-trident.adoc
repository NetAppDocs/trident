...
You should define a Prometheus target to gather the metrics and obtain information about the backends Trident manages, the volumes it creates, and so on. See link:https://prometheus-operator.dev/docs/developer/getting-started/[Prometheus Operator documentation^].
...
* Trident AutoSupport does not gather or transmit Personally Identifiable Information (PII) or Personal Information. It comes with a https://www.netapp.com/pdf.html?item=/media/14114-enduserlicenseagreementworldwide.pdf[EULA^] that is not applicable to the Trident container image itself. You can learn more about NetApp's commitment to data security and trust https://www.netapp.com/pdf.html?item=/media/14114-enduserlicenseagreementworldwide.pdf[here^].
