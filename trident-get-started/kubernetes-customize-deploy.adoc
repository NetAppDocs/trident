...
Astra Trident runs as a single controller pod and one or more node pods that must be present on any host where you want to potentially mount an Astra Trident volume. 
