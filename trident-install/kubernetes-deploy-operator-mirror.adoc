...
Log in to the Linux host and verify it is managing a working and link:../trident-get-started/requirements.html[supported Kubernetes cluster] and that you have the necessary privileges.
...
----
wget https://github.com/NetApp/trident/releases/download/v6.0/trident-installer-26.06.0.tar.gz
...
In `/deploy/operator.yaml`, update `image: docker.io/netapp/trident-operator:26.06.0` to reflect the location of your image registry. Your link:../trident-get-started/requirements.html#container-images-and-corresponding-kubernetes-versions[Trident and CSI images] can be located in one registry or different registries, but all CSI images must be located in the same registry. For example:

* `image: <your-registry>/trident-operator:26.06.0` if your images are all located in one registry.
* `image: <your-registry>/netapp/trident-operator:26.06.0` if your Trident image is located in a different registry from your CSI images.
...
autosupportImage: "<your-registry>/trident-autosupport:26.06"
tridentImage: "<your-registry>/trident:26.06.0"
----
--
...
...
Spec:
  Autosupport Image:  <your-registry>/trident-autosupport:26.06
  Debug:              true
  Image Registry:     <your-registry>
  Namespace:          trident
  Trident Image:      <your-registry>/trident:26.06.0
Status:
