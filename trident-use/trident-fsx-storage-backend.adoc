...
== Create a Trident Backend Configuration (TBC)
...
The steps in this section will cover how to create the backend separately. For information on how to use the Automatic Backend feature, refer to xref:trident-fsx-storageclass-pvc.html[Configure StorageClass and PVC] for more information.
