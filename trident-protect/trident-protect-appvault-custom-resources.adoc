...
=== ##EKS Pod Identity for AWS S3 authentication##

##Trident protect supports AWS EKS Pod Identity for Kopia data mover operations. This feature enables secure access to S3 buckets without storing AWS credentials in Kubernetes secrets.##
...
##To learn about configuring EKS Pod Identity, refer to the https://docs.aws.amazon.com/eks/latest/userguide/pod-identities.html[AWS EKS Pod Identity documentation^].##
