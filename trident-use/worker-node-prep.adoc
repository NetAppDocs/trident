...
.SCSI over FC
----
SCSI over Fiber Protocol (FC) is a tech preview feature in Trident 24.10.
----

link:https://docs.netapp.com/us-en/ontap/san-config/configure-fc-nvme-hosts-ha-pairs-reference.html[Ways to configure FC & FC-NVMe SAN hosts] if you are using `SCSI over FC` for FC protocol. 
