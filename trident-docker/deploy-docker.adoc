...
summary: Astra Trident for Docker provides direct integration with the Docker ecosystem for NetApp’s storage platforms. It supports the provisioning and management of storage resources from the storage platform to Docker hosts, with a framework for adding additional platforms in the future.
---
...
EOF
----
. Start Astra Trident using the managed plugin system.
+
----
