...
autosupportImage: "<your-registry>/netapp/trident-autosupport:24.10"
tridentImage: "<your-registry>/netapp/trident:24.10.0"
----
--
====
...
...
Spec:
  Autosupport Image:  <your-registry>/netapp/trident-autosupport:24.10
  Debug:              true
  Image Registry:     <your-registry>/sig-storage
  Namespace:          trident
  Trident Image:      <your-registry>/netapp/trident:24.10.0
Status:
