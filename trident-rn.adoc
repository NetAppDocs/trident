...
** Added support for Google Cloud NetApp Volumes Flex Unified ZONAL pools for SAN (iSCSI) workloads.

==== Fixes

* *Kubernetes*:

** Fixed Google Cloud NetApp Volumes (GCNV) SAN behavior to allow Flex Unified ZONAL pools for block (iSCSI) workloads.
** Fixed Google Cloud NetApp Volumes (GCNV) NAS UNIFIED pool volume handling to improve reliability of volume create and lookup operations.
