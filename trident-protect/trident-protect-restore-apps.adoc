...
##You can restore a backup to the original namespace at any time. When you perform an in-place restore from a backup, Trident Protect automatically manages protection schedules and in-progress operations to prevent invalid recovery points.##
