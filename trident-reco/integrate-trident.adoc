...
For details on Cloud Volumes Service on Google Cloud service types and service levels, refer to link:../trident-use/gcp.html[Learn about Astra Trident support for CVS for GCP].
