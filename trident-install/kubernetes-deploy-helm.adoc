...
. Use `helm install` and specify a name for your deployment as in the following example where `23.07.0` is the version of Astra Trident you are installing. 
+
----
...
For example, to change the default value of `debug`, run the following `--set` command where `23.07.0` is the version of Astra Trident you are installing:
