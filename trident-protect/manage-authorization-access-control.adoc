...
Note that no users can create application data management CRs in the default `trident-protect-system` namespace. You need to create application data management CRs in other namespaces (as a best practice, create application data management CRs in the same namespace as their associated application).
