...
Supported for raw-block volumes.
| Yes 
| Yes

Not managed by Astra Trident.
| Yes 
|Yes
...
Not managed by Astra Trident and not PV granular.
|Yes 
| Yes
...
Astra Trident provides two drivers to manage Azure NetApp Files: 
...
Learn more about the drivers and their configuration in link:https://azure.microsoft.com/en-us/services/netapp/[Astra Trident backend configuration for Azure NetApp Files^].
