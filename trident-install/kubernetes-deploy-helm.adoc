...
. Use `helm install` and specify a name for your deployment as in the following example where `100.2404.0` is the version of Astra Trident you are installing. 
+
----
