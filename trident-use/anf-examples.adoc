...
IMPORTANT: You can specify either a named cloud environment (`cloudName`) OR a custom cloud environment ( using `adAuthorityHost`, `audience`, and `endpoint`), but NOT both.
  | `AzurePublic`
