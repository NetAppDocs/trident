...
If you are looking to customize the installation beyond what `TridentOrchestrator`'s arguments allow, you should consider using `tridentctl` to generate custom YAML manifests that you can modify as needed.
