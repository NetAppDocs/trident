...
WARNING: FSx for NetApp ONTAP volumes come preconfigured with a SnapMirror. Deleting PVCs will not succeed, as Trident cannot modify or break them. Users will need to delete their PVs manually and clean them up on FSx.
