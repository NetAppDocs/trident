...
NOTE: Cluster-scoped resources are included in the backup, snapshot, or clone if they are explicitly referenced in the application definition or if they have references to any of the application namespaces. 
