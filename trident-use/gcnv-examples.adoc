...
keywords: trident backend, google cloud netapp files, nfs volumes, nfs
...
CVS-Performance values are `flex`, `standard`, `premium`, or `extreme`.
...
.Backend configuration example for Google Cloud Netapp Files
[%collapsible%closed]
====
----
