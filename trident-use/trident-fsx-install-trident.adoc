...
`eksctl create addon --cluster K8s-arm --name netapp_trident-operator --version v24.02.0-eksbuild.`
`eksctl create addon --cluster K8s-arm --name netapp_trident-operator --version v24.02.0-eksbuild.1` (with a dedicated version)
--
