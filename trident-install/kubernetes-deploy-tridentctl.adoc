...
[%collapsible%closed]
====
For more information about force detach, refer to link:..trident-get-started/kubernetes-customize-deploy.html#details-about-force-detach[Details about force detach^].
----
