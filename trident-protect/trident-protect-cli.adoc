...
[source,console]
----
docker pull cr.astra.netapp.io/trident-protectctl:24.10.0
----
. Install the plugin on your local machine:
+
[source,console]
----
docker run --rm -v $(pwd):/pctl-tmp cr.astra.netapp.io/trident-protectctl:24.10.0 cp protectctl /pctl-tmp
----
