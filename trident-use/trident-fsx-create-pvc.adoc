...
Once you have created the Trident backend and StorageClass you are ready to create a PVC. Once the PVC has been created, you can mount the volume in a pod.
