...
* You can perform a direct upgrade to any target release that is within a four-release window of your installed version. For example, you can directly upgrade from 23.04 (or any 23.01 dot release) to 24.06.
...
. First upgrade from 22.07 to 23.07.  

. Then upgrade from 23.07 to 24.06.
