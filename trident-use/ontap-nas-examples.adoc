...
| Active Directory admin user or user group with full access to SMB shares. Use this parameter to provide admin rights to SMB share with full control access. |
