...
===============================
Amazon FSx for NetApp ONTAP volumes come preconfigured with a SnapMirror. Trident cannot modify or break the SnapMirror. To delete PVCs, you need to manually delete the PV and the FSx for ONTAP volume.

To prevent this issue:

* Do not use **Quick create** to create the FSx for ONTAP file system. This will enable automatic backups.
* When using **Standard create**, disable automatic backup.
+
