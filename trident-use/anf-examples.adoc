...
|`filePoolVolumes` |List of parent volumes. Applicable for `azure-netapp-files-subvolume` backends only |"[]"
...
[%collapsible%open]
====
This is a basic Azure NetApp Files Sub volumes backend. It uses two pre-created parent volumes named "parent-volume-1" and "parent-volume-2".
...
----
{
    ...
    "subscriptionID": "9f87c765-4774-fake-ae98-a721add45451",
    "capacityPools": ["anf-resourcegroup/anf-account/ultra-pool"],
    "filePoolVolumes": [
        "/anf-resourcegroup/anf-account/ultra-pool/parent-volume-1",
        "/anf-resourcegroup/anf-account/ultra-pool/parent-volume-2"
        ],
    "tenantID": "68e4f836-edc1-fake-bff9-b2d865ee56cf",
    "clientID": "dd043f63-bf8e-fake-8076-8de91e5713aa",
    "clientSecret": "SECRET",
