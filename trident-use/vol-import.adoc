...
Astra Trident imports the FlexVol and associates it with the PVC definition. 

For managed volumes, Astra Trident also renames the FlexVol to the `pvc-<uuid>` format and the LUN within the FlexVol to `lun0`.
