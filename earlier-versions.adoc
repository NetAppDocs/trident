...
[.lead]
If you aren't running Trident 26.06, the documentation for previous releases is available based on the link:get-help.html[Trident support lifecycle]. 

* https://docs.netapp.com/us-en/trident-2602/index.html[Trident 26.02^]
