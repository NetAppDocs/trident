...
* You can share to all namespaces using `*`. For example, `trident.netapp.io/clone: *`
...
* For PVCs provisioned using ontap-nas drivers, read-only clones are not supported.
