...
keywords: trident backend, google could netapp files, smb volumes, smb, windows, active directory, csi proxy, aks, cloud identity
...
If you are using Google Cloud NetApp Files for the first time or in a new location, some initial configuration is required to set up Google Cloud NetApp files and create an NFS volume. Refer to https://docs.microsoft.com/en-us/azure/azure-netapp-files/azure-netapp-files-quickstart-set-up-account-create-volumes[Azure: Set up Azure NetApp Files and create an NFS volume^].
