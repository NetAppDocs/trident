...
*** Added ability to define a secret for data mover encryption
*** Added ability to manually run an execution hook
*** Added ability to configure Security Context Constraints at install time
*** Added ability to configure node selector and affinity rules at install time
*** Added support for HTTP and HTTPS egress proxy for AppVault objects
