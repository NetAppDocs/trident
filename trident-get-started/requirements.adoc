...
* OpenShift 4.14 - 4.18
* Rancher Kubernetes Engine 2 (RKE2) v1.27.x - 1.33.x
_Note: While Trident is supported on Rancher Kubernetes Engine 2 (RKE2) versions 1.27.x - 1.33.x, it has been qualified on RKE2 v1.26.7+rke2r1 and v1.28.5+rke2r1._
