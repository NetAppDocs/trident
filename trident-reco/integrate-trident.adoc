...
Astra Trident provides two drivers to manage the link:https://azure.microsoft.com/en-us/services/netapp/[Azure NetApp Files^] service: `azure-netapp-files` and `azure-netapp-files-subvolume`.
...
More information about the drivers and their configuration can be found in link:https://azure.microsoft.com/en-us/services/netapp/[Astra Trident backend configuration for Azure NetApp Files^].
...
| `azure-netapp-files-subvolume` | Yes | Yes | No  | No  | Yes | No              |
|===
