...
+
For Kubernetes 1.20 and above, use v1 snapshot CRDs with snapshot components of v5.0 or above. For Kubernetes versions 1.18-1.19, use v1beta1 with v3.0.3 snapshot components.
+
[role="tabbed-block"]
====
.v5.0 components
...
+
For Kubernetes 1.20 and above use v5.0 or above. For Kubernetes versions 1.18-1.19 use v3.0.3
+
...
----
$ cat snap-sc.yaml
#Use apiVersion v1 for Kubernetes 1.20 and above. For Kubernetes 1.18 - 1.19, use apiVersion v1beta1.
