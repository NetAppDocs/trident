...
|Enable secure HTTPS communication with the S3 endpoint.
|true
|"true", "false"
|`providerConfig.s3.proxyURL`
|Specify the URL of the proxy server used to connect to S3.
|None
|http://proxy.example.com:8080
|`providerConfig.s3.rootCA`
|Provide a custom root CA certificate for SSL/TLS verification. 
|None
|"CN=MyCustomCA"
|`providerConfig.s3.useIAM`  
|Enable IAM authentication for accessing S3 buckets. Applicable for EKS Pod Identity.
|false
|true, false
|===
