...
.Before you begin
Review link:upgrade-trident.html#step-3-select-an-upgrade-method[Select an upgrade method] before upgrading using `tridentctl`. 
...
----
. Reinstall Trident. Refer to link:../trident-install/kubernetes-deploy-tridentctl.html[Install Trident using tridentctl]. 
