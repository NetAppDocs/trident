...
+
NOTE: _While Trident is supported on Rancher Kubernetes Engine 2 (RKE2) versions 1.27.x - 1.35.x, Trident has currently been qualified on RKE2 v1.28.5+rke2r1 only._
