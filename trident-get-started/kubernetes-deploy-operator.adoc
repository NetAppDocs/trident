...
You can deploy Astra Trident with the Trident operator. You can deploy the Trident operator and install Astra Trident using Helm or manually deploy the operator. 
