...
NOTE: Typically, you do not need to manage the `VolumeSnapshotContent` object. An exception to this is when you want to link:../trident-use/vol-snapshots.html#import-a-volume-snapshot[import a volume snapshot] crated outside of Astra Trident. 
