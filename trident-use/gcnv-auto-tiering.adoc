...
Post-provisioning changes are not supported in Trident 26.06.
...
Trident 26.06 supports the following auto-tiering capabilities for Google Cloud NetApp Volumes:
