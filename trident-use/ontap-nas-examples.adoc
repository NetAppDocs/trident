...
For seamless MetroCluster switchover, you must specify a SVM management LIF. This feature is *tech preview*.|“10.0.0.1”, “[2001:1234:abcd::fefe]”
...
* REST is not supported with MetroCluster.
===============================
